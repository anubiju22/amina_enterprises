            ...
            Row(
              ...
              children: [
                HomeCategories(
                  ...
                  label: 'Footwears',
                  color: const ColorFilter.mode(homeFootColor, BlendMode.srcIn),
                  onClick: () {
                ...
                HomeCategories(
                  ...
                  label: 'Bags',
                  color: const ColorFilter.mode(homeBagColor, BlendMode.srcIn),
                  onClick: () {},
                ),
                HomeCategories(
                  path: 'assets/svg/home_jacket.svg',
                  label: 'Apparels',
                  color: const ColorFilter.mode(homeAppColor, BlendMode.srcIn),
                  onClick: () {},
                )
              ],
            )
